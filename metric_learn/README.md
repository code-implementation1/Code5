...
[model weights](https://www.mindspore.cn/resources/hub/details/en?mindspore/1.3/resnest50_imagenet2012) as a pre-trained model, then modify the classification layer to use
