...
class LRBranch(nn.Cell):
    ...
    def construct(self, img, inference):
        ...
        lr16x = ops.interpolate(enc32x, scale_factor=2, align_corners=False)
        lr16x = self.conv_lr16x(lr16x)
        lr8x = ops.interpolate(lr16x, scale_factor=2, align_corners=False)
...
class HRBranch(nn.Cell):
    ...
    def __init__(self, hr_channels, enc_channels):
        ...
        self.resize_bilinear = ops.interpolate
