...
class EvalCell(nn.Cell):
    ...
    def construct(
        ...
        (
            pred_bboxes, pred_labels, pred_mask, pred_iou, pred_valids, _
        ) = self.net(
        ...
        return (
            ...
            (pred_bboxes, pred_labels, pred_mask, pred_iou, pred_valids),
...
class PostProcessorMSRCNN:
    ...
    def __call__(
            self, pred_bboxes, pred_labels, pred_masks, pred_iou, pred_valid,
            metas, **kwargs
    ):
        """Run post-processing."""
        size = len(metas)
